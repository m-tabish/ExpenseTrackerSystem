...
date_label = tk.Label(root, text="Date",font=("Airal",18),fg="white",bg="black")
date_label.place(y=340,x=10)

date_entry = tk.Entry(root,font=("Airal",18),fg="white",bg="black",borderwidth=0.5)
date_entry.config(width=14)
date_entry.place(y=340,x=100)

spent_label = tk.Label(root, text="Spent On ",font=("Airal",18),fg="white",bg="black")
spent_label.place(y=390,x=10)

spent_entry = tk.Entry(root,font=("Airal",18),fg="white",bg="black",borderwidth=0.5)
spent_entry.config(width=14)
spent_entry.place(y=390,x=100)


amount_label = tk.Label(root, text="Amount ",font=("Airal",18),fg="white",bg="black")
amount_label.place(y=440,x=10)

amount_entry = tk.Entry(root,font=("Airal",18),fg="white",bg="black",borderwidth=0.5)
amount_entry.config(width=14)
amount_entry.place(y=440,x=100)


# Buttons
clean = Button(root, text="Clear", bg="black", fg="green",font=("Airal",18))
clean.place(y=360,x=280)

add = Button(root, text="Add", bg="black", fg="green",font=("Airal",18))

add.place(y=410,x=280)

total_amount = Button(root, text="Total Amount", bg="black", fg="green",font=("Airal",18))
total_amount.place(y=360,x=410)

update = Button(root, text="      Update     ", bg="black", fg="green",font=("Airal",18))
update.place(y=410,x=410)


delete = Button(root, text="Delete", bg="black", fg="green",font=("Airal",18))
delete.place(y=360,x=590)

exit = Button(root, text="Exit", bg="black", fg="green",font=("Airal",18))
